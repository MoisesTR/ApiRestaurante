...
VALUES(1, 1, 'Nicaragua', 'NIC',558, '505')
,(2, 2, 'Estados Unidos','USA',840,'001')
,(3, 5, 'Taiwán (República de China)','TWN',158,'886')
,(4, 4,  'China','CHN', 156, '086')
,(5, 6, 'Costa Rica','CRI', 188,'506')
,(6, 7, 'Honduras','HND',340,'504')
,(7, 8, 'Guatemala','GTM',320,'502')
GO
...
VALUES(1,'Cedula',NULL)
,(2,'Numero RUC', 'Registro Unico de Contribuyentes.')
GO
...
VALUES	(1,1,'Producto Seco','Todos aquellos productos que no necesitan refrigeracion.')
		,(2,1,'Carnes','Todas los tipos de carnes.')
		,(3,1,'Salsas','Todos los tipos de salsas')
...
VALUES(1,'Empaque Pedido(Compra)',NULL)
, (2,'Empaque Envio',NULL)
, (3,'Empaque Venta',NULL)
, (4,'Empaque Almacenamiento',NULL)
GO
