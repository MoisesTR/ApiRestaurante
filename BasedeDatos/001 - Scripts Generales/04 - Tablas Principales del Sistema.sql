...
EXEC USP_DELETE_ALL_F_CONSTRAINT_TABLE 'dbo.DETALLE_BODEGA_AP'
EXEC USP_DELETE_ALL_F_CONSTRAINT_TABLE 'dbo.DETALLE_ENTRADA_BODEGA_AREA_PRODUCCION'
EXEC USP_DELETE_ALL_F_CONSTRAINT_TABLE 'dbo.ENTRADA_BODEGA_AREA_PRODUCCION'
EXEC USP_DELETE_ALL_F_CONSTRAINT_TABLE 'dbo.PRODUCTO_ORIGEN'
EXEC USP_DELETE_ALL_F_CONSTRAINT_TABLE 'dbo.PRODUCTO'
EXEC USP_DELETE_ALL_F_CONSTRAINT_TABLE 'dbo.CLASIFICACION_PRODUCTO'
EXEC USP_DELETE_ALL_F_CONSTRAINT_TABLE 'dbo.CATEGORIA_PRODUCTO'
EXEC USP_DELETE_ALL_F_CONSTRAINT_TABLE 'dbo.UNIDAD_MEDIDA_FUNCIONAL'
EXEC USP_DELETE_ALL_F_CONSTRAINT_TABLE 'dbo.UNIDAD_MEDIDA'
...
IF OBJECT_ID('dbo.MOTIVO_BAJA_PRODUCTO') IS NOT NULL
	DROP TABLE dbo.MOTIVO_BAJA_PRODUCTO
GO
CREATE TABLE dbo.MOTIVO_BAJA_PRODUCTO(
...
GO---------------------
IF OBJECT_ID('dbo.CLASIFICACION_UNIDAD_MEDIDA') IS NOT NULL
	DROP TABLE dbo.CLASIFICACION_UNIDAD_MEDIDA
GO
CREATE TABLE dbo.CLASIFICACION_UNIDAD_MEDIDA (
...
IF OBJECT_ID('dbo.UNIDAD_MEDIDA') IS NOT NULL
...
IF OBJECT_ID('dbo.CLASIFICACION_UNIDAD_MEDIDA_FUNCIONAL') IS NOT NULL
	DROP TABLE dbo.CLASIFICACION_UNIDAD_MEDIDA_FUNCIONAL
GO
CREATE TABLE dbo.CLASIFICACION_UNIDAD_MEDIDA_FUNCIONAL(
...
IF OBJECT_ID('dbo.UNIDAD_MEDIDA_FUNCIONAL') IS NOT NULL
	DROP TABLE dbo.UNIDAD_MEDIDA_FUNCIONAL
GO
CREATE TABLE dbo.UNIDAD_MEDIDA_FUNCIONAL(
...
IF OBJECT_ID('dbo.CATEGORIA_PRODUCTO') IS NOT NULL
...
IF OBJECT_ID('dbo.CLASIFICACION_PRODUCTO') IS NOT NULL
	DROP TABLE dbo.CLASIFICACION_PRODUCTO
GO
...
IF OBJECT_ID('dbo.ENVASE') IS NOT NULL
	DROP TABLE dbo.ENVASE
GO
...
IF OBJECT_ID('dbo.TIPO_EMPAQUE_PRODUCTO') IS NOT NULL
	DROP TABLE dbo.TIPO_EMPAQUE_PRODUCTO
GO
...
GO
IF OBJECT_ID('dbo.EMPAQUE') IS NOT NULL
...
GO
IF OBJECT_ID('dbo.ESTADO_PRODUCTO') IS NOT NULL
	DROP TABLE dbo.ESTADO_PRODUCTO
GO
...
CREATE TABLE dbo.PRODUCTO (
    ...
    DescProducto		NVARCHAR(200)		NULL,
    Imagen				NVARCHAR(100)		NOT NULL	DEFAULT 'nodisponible.png', --	
	Habilitado			BIT DEFAULT 1		NOT NULL,
    CreatedAt			SMALLDATETIME		NOT NULL DEFAULT GETDATE(),
    UpdatedAt			SMALLDATETIME		NULL,
    CONSTRAINT		PK_ID_PRODUCT				PRIMARY KEY (IdProducto),
    CONSTRAINT		FK_PRODUCT_CATEGORIA		FOREIGN KEY ( IdCategoria )
				REFERENCES		dbo.CATEGORIA_PRODUCTO ( IdCategoria ),
	CONSTRAINT		FK_PRODUCT_CLASIF		FOREIGN KEY ( IdClasificacion )
				REFERENCES		dbo.CLASIFICACION_PRODUCTO ( IdClasificacion ),
...
GO
--IF OBJECT_ID('dbo.PRODUCTO_ORIGEN') IS NOT NULL
--	DROP TABLE dbo.PRODUCTO_ORIGEN
--GO
---- OMITIR DE MOMENTO
--CREATE TABLE  dbo.PRODUCTO_ORIGEN(
...
IF OBJECT_ID('dbo.ESTADO_EMPAQUE') IS NOT NULL
	DROP TABLE dbo.ESTADO_EMPAQUE
GO
...
IF OBJECT_ID('dbo.ESTADO_EDICION') IS NOT NULL
	DROP TABLE dbo.ESTADO_EDICION
GO
...
IF OBJECT_ID('dbo.ENTRADA_BODEGA_AREA_PRODUCCION') IS NOT NULL
	DROP TABLE dbo.ENTRADA_BODEGA_AREA_PRODUCCION
GO
CREATE TABLE dbo.ENTRADA_BODEGA_AREA_PRODUCCION (
...
IF OBJECT_ID('dbo.DETALLE_ENTRADA_BODEGA_AREA_PRODUCCION') IS NOT NULL
	DROP TABLE dbo.DETALLE_ENTRADA_BODEGA_AREA_PRODUCCION
GO
CREATE TABLE dbo.DETALLE_ENTRADA_BODEGA_AREA_PRODUCCION (
...
GO
--IF OBJECT_ID('dbo.DETALLE_BODEGA_AP') IS NOT NULL
--	DROP TABLE dbo.DETALLE_BODEGA_AP
--GO
----NOMBRE ANTERIOR 
